...
I pioneered a way to observe 3D winds from infared satellites through a computer vision algorithm that uses concepts from AI (e.g. loss function regularization) Code: [3d-amvs](https://github.com/aouyed/3d-amvs/). I also appeared in the local tv news to talk about project and it also had a mention in the global economic forum. 
